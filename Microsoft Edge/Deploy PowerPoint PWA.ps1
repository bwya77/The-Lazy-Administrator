...
# Example usage
$props = @{
    'ShortcutPath' = Join-Path -Path ([Environment]::GetFolderPath("CommonDesktopDirectory")) -ChildPath 'PowerPoint.lnk'
    'TargetPath'   = $DefaultBrowserPath 
    'Arguments'    = '-profile-directory=Default -app=https://powerpoint.cloud.microsoft/'
    'IconName'     = "powerpoint.ico"
    'IconURL'      = "https://sapwaicons.blob.core.windows.net/icons/powerpoint.ico"
    'IconPath'     = "C:\Temp"
}
