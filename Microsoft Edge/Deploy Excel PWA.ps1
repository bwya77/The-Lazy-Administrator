...
# Example usage
$props = @{
    'ShortcutPath' = Join-Path -Path ([Environment]::GetFolderPath("CommonDesktopDirectory")) -ChildPath 'Excel.lnk'
    'TargetPath'   = $DefaultBrowserPath 
    'Arguments'    = '-profile-directory=Default -app=https://excel.cloud.microsoft/'
    'IconName'     = "excel.ico"
    'IconURL'      = "https://sapwaicons.blob.core.windows.net/icons/excel.ico"
    'IconPath'     = "C:\Temp"
}
